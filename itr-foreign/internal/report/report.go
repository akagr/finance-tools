// Package report renders a fa.Report. Every format carries an audit
...
type Renderer interface {
	Render(w io.Writer, r *fa.Report) error
}
...
// paths written.
func Write(dir string, formats []Format, r *fa.Report) ([]string, error) {
...
func (mdRenderer) Render(w io.Writer, r *fa.Report) error {
	b := &strings.Builder{}
...
func writeAudit(b *strings.Builder, label string, a fa.Amount) {
	if len(a.Audit) == 0 {
		fmt.Fprintf(b, "| %s | — | — | — | %s |\n", label, inr(a.INR))
		return
	}
...
func (csvRenderer) Render(w io.Writer, r *fa.Report) error {
	b := &strings.Builder{}
...
func (jsonRenderer) Render(w io.Writer, r *fa.Report) error {
...
// and HTML renderers.
func buildView(r *fa.Report) jsonReport {
...
func auditLines(figure string, a fa.Amount) []jsonAudit {
	var out []jsonAudit
